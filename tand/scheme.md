# схема
схема ставит все точки над и. выбирает цели, используемые решения для их достижения и все нюансы по пути к ним..<nobr hidden>подробнее что такое схема и почему тут все так как есть, смотрите [здесь](awareness.md)</nobr>
